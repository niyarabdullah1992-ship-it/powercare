...
function weeklySummaryHtml(companyName, stats, language = 'en') {
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f4f1e9;padding:34px 12px;"><tr><td align="center">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fffefa;border:1px solid #d9cfbc;border-radius:12px;overflow:hidden;box-shadow:0 12px 36px rgba(16,43,62,.12);">
      ...
      <tr><td style="padding:26px 28px 24px;text-align:center;background:#14284B;"><img src="${POWERCARE_MARK_URL}" width="68" height="68" alt="NiroVera" style="display:block;margin:0 auto 11px;padding:7px;border-radius:8px;background:#ffffff;" /><div style="font-family:Arial,Helvetica,sans-serif;font-size:23px;font-weight:700;letter-spacing:1.4px;color:#ffffff;">NiroVera</div><div style="width:38px;height:2px;margin:10px auto;background:#1E9E63;font-size:0;line-height:0;">&nbsp;</div><div style="font-size:12px;font-weight:600;letter-spacing:.35px;color:#94A3B8;">${c.header}</div></td></tr>
