...
import { scoreEmployee, scoreBoard, PERF_WEIGHTS, blendHseTerm } from "../src/lib/perfDerivations.js";
...
assert.equal(checkHazardCloseGate({ controlId: "eng", inherent: 9, beforePhoto: null, afterPhoto: 1 }).error, "PHOTOS_REQUIRED");
assert.equal(checkHazardCloseGate({ controlId: "eng", inherent: 9, beforePhoto: 1, afterPhoto: 1 }).ok, true);
