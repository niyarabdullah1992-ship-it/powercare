...
export default function SapExecutiveTable({ rows }) {
  return (
    <div className="overflow-hidden rounded-lg border border-accent/35 bg-card">
      <div className="grid grid-cols-[.8fr_1.2fr_1.2fr] bg-primary px-4 py-3 text-xs font-bold text-primary-foreground"><span>المعيار</span><span>تجربة SAP التقليدية</span><span className="text-accent">NiroVera</span></div>
