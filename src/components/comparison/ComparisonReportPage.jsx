...
export default function ComparisonReportPage({ page, total }) {
  return <article data-pdf-page dir="rtl" className="relative mx-auto flex h-[1123px] w-[794px] shrink-0 flex-col overflow-hidden bg-background px-11 py-10 text-foreground shadow-elevated">
    ...
    <header className="flex items-center justify-between border-b border-accent/30 pb-5">
      <div className="flex items-center gap-3"><Logo size={38} /><div><p className="font-heading text-lg font-bold">NiroVera</p><p className="text-[8px] tracking-[.2em] text-muted-foreground">INDEPENDENT COMPARISON</p></div></div>
    ...
    <div className="overflow-hidden rounded-lg border border-border bg-card">
      <div className="grid grid-cols-[1.05fr_1.55fr_1.55fr_.9fr] bg-primary px-3 py-3 text-[10px] font-bold text-primary-foreground"><span>المعيار<br />Criterion</span><span>NiroVera<br />NiroVera</span><span>ساب التقليدي<br />Traditional SAP</span><span>النتيجة<br />Verdict</span></div>
