...
export default function StationWarehousePicker({ stations = [], value, onChange, locked, allowAll = false, ar }) {
  ...
  const allLabel = ar ? "جميع المحطات" : "All stations";
