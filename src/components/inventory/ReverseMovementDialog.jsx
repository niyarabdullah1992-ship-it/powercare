...
export default function ReverseMovementDialog({ movement, items, stations, onClose, onConfirm, ar }) {
  ...
  const blocked = effects.some((effect) => effect.before + effect.delta < 0);
