...
export default function InventoryPeriodReport({ reportData, ar }) {
  ...
  const exportPdf = () => printReport({ title, companyName: company?.name || "", periodLabel, dir: ar ? "rtl" : "ltr", stats: report.stats, sections: report.sections, logoUrl: branding.logoUrl || "", color: branding.color || "#b07d3f", theme: "inventoryPowerCare" });
