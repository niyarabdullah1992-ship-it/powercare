...
export default function DailyHoursTable({ selectedMonth, dailyHours = [], totalHours, canEdit, lang, onChange }) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border">
      <div className="grid grid-cols-[1fr_8rem] bg-muted/60 px-3 py-2 text-[11px] font-semibold text-muted-foreground"><span>{ar ? "اليوم والتاريخ" : "Day and date"}</span><span>{ar ? "ساعات العمل" : "Work hours"}</span></div>
