...
export default function FlexOrgTree({ data, company, currentUser, lang }) {
  ...
  const actions = { start: setDragging, end: () => setDragging(null), edit: setEditing, toggleEscalation: (employeeId) => toggleComplaintEscalationMember(company.id, employeeId), drop: (targetId, mode) => { moveOrgNode(company.id, dragging, targetId, mode); setDragging(null); } };
