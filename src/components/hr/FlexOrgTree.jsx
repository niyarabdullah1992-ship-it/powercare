...
import { initializeOrgTree, moveOrgNode, saveOrgNodeVisualPosition, toggleComplaintEscalationMember } from "@/lib/orgTree";
...
export default function FlexOrgTree({ data, company, currentUser, lang }) {
  ...
  const changeHierarchy = (nodeId, targetId, mode) => moveOrgNode(company.id, nodeId, targetId, mode);
