...
export default function OrgTreeNodeFields({ type, setType, refId, setRefId, title, setTitle, permissions, setPermissions, employees, stations, usedEmployees, editing, ar }) {
