...
export default function HROrgEmployeeNode({ employee, station, ar, title, variant = "employee", compact = false }) {
  ...
  return <Popover><PopoverTrigger asChild><button type="button" className={`rounded-lg border text-start transition hover:-translate-y-0.5 hover:border-accent/70 hover:shadow-md ${styles}`}>
