...
export default function FlexOrgCard({ node, label, stationManagerName, isStationManager, isHierarchyManager, canManage, dragging, complaintLevel, childrenCount, collapsed, onToggleCollapse, onToggleEscalation, onDragStart, onDragEnd, onDrop, onEdit, ar }) {
