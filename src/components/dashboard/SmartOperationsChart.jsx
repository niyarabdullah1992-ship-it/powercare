      ...
      <div className="holo-chart rounded-2xl p-5">
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={data}>
            ...
            <Line type="natural" dataKey="expenses" name={labels.expenses} stroke="hsl(var(--landing-gold-light))" strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 7 }} />
            <Line type="natural" dataKey="complaints" name={labels.complaints} stroke="hsl(var(--landing-gold))" strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 7 }} />
            <Line type="natural" dataKey="inventory" name={labels.inventory} stroke="hsl(var(--accent))" strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 7 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
