...
import { Boxes, UserCheck, ClipboardCheck, PowerOff, Wallet } from "lucide-react";
...
export default function AssetStats({ assets, lang }) {
  ...
  const needInspection = assets.filter((a) => inspectionDue(a) || a.status === "inspection").length;
  ...
  const cards = [
    ...
    { icon: ClipboardCheck, label: lang === "ar" ? "تحتاج فحصاً" : "Need inspection", value: needInspection },
