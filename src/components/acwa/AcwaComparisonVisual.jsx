...
export default function AcwaComparisonVisual({ data }) {
  return <div className="h-full overflow-hidden">
    <div className="grid grid-cols-[1.4fr_1fr_1fr] bg-secondary px-3 py-2 text-center text-[9px] font-bold"><span className="text-left">Capability · القدرة</span><span>PowerCare</span><span>{data.traditionalLabel || "Traditional"}</span></div>
