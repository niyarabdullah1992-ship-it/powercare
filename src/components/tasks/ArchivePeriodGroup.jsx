...
export default function ArchivePeriodGroup({ group, t, renderTask }) {
  ...
  return (
    <div className="rounded-xl border border-border bg-background overflow-hidden">
      ...
      >
        ...
        <span className={`px-2 py-0.5 rounded-full border text-[10px] font-body shrink-0 ${badge.cls}`}>{t(badge.key)}</span>
