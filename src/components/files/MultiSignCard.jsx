...
export default function MultiSignCard({ currentUser, companyId, employees, ar, onCreated }) {
  ...
  const reset = () => { setStep(1); setDoc(null); setSigners([{ name: "", email: "", employeeId: null, role: "", stationId: null, signatureUrl: "", external: false }]); setSpots({}); setStampTheme("heritage"); setResult(null); };
