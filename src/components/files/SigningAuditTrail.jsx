...
export default function SigningAuditTrail({ events = [], ar }) {
  ...
  return <details className="rounded-xl border border-border bg-muted/40 p-3">
    <summary className="cursor-pointer text-xs font-semibold">{ar ? "سجل التدقيق الكامل" : "Full audit trail"}</summary>
    <div className="mt-3 space-y-3 border-s border-border ps-3">
