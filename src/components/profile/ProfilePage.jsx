...
export default function ProfilePage({ page }) {
  ...
  return <article data-pdf-page className="relative mx-auto flex h-[1123px] w-[794px] shrink-0 flex-col overflow-hidden bg-background text-foreground shadow-elevated">
    ...
    <header className="flex items-center justify-between px-12 pb-5 pt-10"><div className="flex items-center gap-3"><Logo size={38} wordmark={false} /><div><p className="font-heading text-lg font-bold">NiroVera</p><p className="text-[8px] tracking-[.24em] text-muted-foreground">ENTERPRISE OPERATIONS</p></div></div><span className="font-mono text-xs text-accent">{page.number} / 25</span></header>
