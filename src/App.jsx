...
const HROrgTreePage = lazy(() => import('./pages/HROrgTreePage'));
...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      <Route path="/app/hr-tree" element={<RequireAuth><HROrgTreePage /></RequireAuth>} />
      ...
      <Route path="/app/cameras" element={<RequireAuth><Cameras /></RequireAuth>} />
