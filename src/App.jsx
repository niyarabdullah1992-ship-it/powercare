...
const LocalPreviewEntry = lazy(() => import('./pages/LocalPreviewEntry'));
...
function AppRoutes() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/app/custody" element={<Navigate to="/app/assets" replace />} />
      <Route path="/app/accounting" element={<Navigate to="/app/payroll" replace />} />
