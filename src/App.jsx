...
const StationTeamManagement = lazy(() => import('./pages/StationTeamManagement'));
...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      <Route path="/app/hr/stations/:stationId" element={<RequireAuth><StationTeamManagement /></RequireAuth>} />
