...
export const GUIDE_INTERCONNECTION = {
  ...
  bodyAr: [
    "NiroVera ليس مجموعة أدوات متجاورة، بل منظومة واحدة تبدأ من ذرّة أساسية هي «الفرع». الفرع تحمل الموقع الجغرافي ونطاق المسافة، ويرتبط بها الموظفون والورديات — فيتولد منها الحضور الموثق. الحضور يغذي التقارير الشهرية ولوحة حالة الفريق ونسبة الحضور في لوحة التحكم.",
    "المهام تنظَّم داخل الفروع نفسها في مجلدات وأقسام، وتأخّرها أو توقفها لا يبقى حبيس القسم: يتصاعد تلقائيًا عبر الهيكل الإداري، ويرفع درجة المخاطر في مركز القيادة. والهيكل الإداري ذاته هو الذي يوجّه الشكاوى والبلاغات المجهولة والاعتراضات — سلّم واحد يخدم كل أنواع التصعيد.",
    "السلامة المهنية ترصد الحوادث والمخاطر لكل فرع، فتغذي درجة الاستقرار ولوحة الرادار التنبؤي. والتقارير اليومية المعتمدة، والأداء، والنقاط التحفيزية — كلها تصب في قسم التحليلات والمقارنات، وتخرج من مركز التصدير بهوية الشركة البصرية، وتُختم عند الحاجة بتوقيع رقمي برقم تحقق مشفر يضمن عدم التلاعب.",
...
export const GUIDE_SECTIONS = [
  {
    ...
    bodyAr: [
      "لوحة التحكم هي أول ما يراه المستخدم بعد تسجيل الدخول، وهي تتكيّف تلقائيًا مع دور المستخدم: فالمالك والمدير التنفيذي يريان صورة شاملة للشركة كلها، بينما يرى مدير الفرع بيانات فرعه فقط، ويرى الموظف العادي مهامه وحضوره الشخصي.",
      "تعرض اللوحة بطاقات إحصائية فورية: عدد الموظفين، والفروع النشطة، والمهام الجارية والمتأخرة، ونسب الحضور اليومية، مع رسم بياني لاتجاه الحضور خلال الأيام الماضية. وتتضمن لوحة «الإجراءات المعلّقة» التي تجمع كل ما يحتاج قرارًا من المدير في مكان واحد: طلبات إجازة، وشهادات بانتظار الاعتماد، ومهام بانتظار مراجعة الإنجاز.",
      "كما تضم اللوحة خريطة تفاعلية تُظهر مواقع جميع الفروع تلقائيًا (من الإحداثيات أو اسم المدينة المسجل)، وملخصًا يوميًا ذكيًا يولّده الذكاء الاصطناعي يلخّص أهم ما حدث في الشركة، وتنبيهات ذكية استباقية تنبه المدير لأي خلل قبل أن يتفاقم.",
    ],
    bodyEn: [
  ...
  {
    image: IMG.stations,
    titleAr: "الفروع (مقرات العمل)",
    titleEn: "Stations (Work Sites)",
    bodyAr: [
      "قسم الفروع هو سجل مقرات العمل في الشركة: لكل فرع اسم وموقع ونوع (كهرباء/مياه/غيره) وحالة تشغيلية (نشطة/صيانة) ومدير مسؤول. يمكن إضافة عدد غير محدود من الفروع وتعديلها أو حذفها في أي وقت.",
      "الميزة الجوهرية هي تحديد الموقع الجغرافي الدقيق لكل فرع على خريطة تفاعلية: يبحث المدير عن العنوان أو ينقر على الخريطة مباشرة، ثم يحدد «نطاق المسافة المسموح» بالأمتار حول المقر. هذا النطاق هو ما يُستخدم لاحقًا للتحقق من حضور الموظفين — فلا يُقبل تسجيل حضور من خارج الدائرة المحددة.",
      "يمكن تعيين موظف واحد مديرًا لعدة فروع في آن واحد، وتعرض كل فرع تحليلات خاصة بها: عدد موظفيها، ومهامها الجارية، ونسب إنجازها، وسجل السلامة الخاص بها.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    bodyAr: [
      "سجل شامل لكل موظفي الشركة بأدوارهم المختلفة: مالك، مدير عمليات، مدير برامج، مدير فرع، وموظف. لكل موظف ملف وظيفي كامل على نمط أنظمة SAP يشمل: البيانات المهنية، والمسمى الوظيفي، والراتب، والشهادات والمؤهلات (مع دورة اعتماد: رفع → مراجعة → قبول/رفض)، وأرصدة الإجازات بأنواعها.",
  ...
  },
  {
    ...
    bodyAr: [
      "نظام مهام هرمي مرن: ينشئ المدير «هدفًا» محددًا بعدد مهام ومدة زمنية (أو نطاق تواريخ مخصص)، ويسنده إلى موظف بعينه أو إلى فريق فرع كاملة أو فريق المقر الرئيسي، مع أولوية (منخفضة/متوسطة/عالية) وخطوات تفصيلية وملفات مرفقة.",
      "تُنظَّم المهام داخل مجلدات وأقسام ينشئها المستخدم بنفسه لكل فرع — بنية تصفح على نمط المجلدات يتنقل فيها من الفرع إلى القسم إلى المهمة، مع إمكانية إعادة الترتيب وإعادة التسمية. ويصنّف «الأرشيف الذكي» المهام المكتملة حسب مدتها: سنوية، نصف سنوية، ربع سنوية، وشهرية.",
  ...
  },
  {
    ...
    bodyAr: [
      "الفكرة الجوهرية للمنصة: لا يُقبل تسجيل الحضور إلا إذا كان الموظف فعليًا داخل النطاق الجغرافي المحدد لمقر عمله. عند الضغط على «تسجيل حضور» يُقرأ موقع الجهاز بدقة عالية ويُقارن بإحداثيات الفرع المخزنة في الخادم — ولا يمكن التلاعب بالإحداثيات من جهة المستخدم لأن التحقق يتم في الخادم حصرًا.",
      "يشمل النظام: تسجيل حضور وانصراف يومي، وأعذار التأخر والغياب مع مرفقات، وجداول ورديات لكل فرع (صباحية/مسائية/ليلية قابلة للتخصيص) مع إسناد الموظفين لكل وردية في كل يوم من أيام الأسبوع، وتنبيهات تأخر تلقائية تُرسل للمدير، وتعليم الغائبين تلقائيًا نهاية اليوم عبر مهمة مجدولة.",
  ...
  },
  {
    ...
    bodyAr: [
      "هيكل موارد بشرية مرن بالكامل: تبني الشركة سلّمها الإداري بنفسها بأي عدد من الدرجات (مثل: HR الموقع → HR المجموعة → رئيس العمليات → نائب الرئيس → CHRO)، ولكل درجة نطاق صلاحية (فرع واحد، مجموعة فروع، أو الشركة كلها) وصلاحيات قابلة للتخصيص بندًا بندًا، مع إمكانية إضافة مساعد لكل درجة.",
      "يمكن إعادة ترتيب الدرجات وتعليقها مؤقتًا وحذفها، ويُعاد توجيه أي شكوى عالقة تلقائيًا عند حذف درجة. وتُجمَّع الفروع في «مجموعات» (Clusters) ليُشرف عليها مسؤول HR واحد.",
      "يدير القسم أيضًا طلبات الإجازات بأنواعها (سنوية، مرضية، طارئة...) بأرصدة قابلة للتعديل لكل موظف، ودورة اعتماد كاملة، إضافة إلى قناة تواصل HR لكل موظف تصل رسائلها إلى مسؤول HR المختص بفرعه تلقائيًا.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "لكل بلاغ نوع (شكوى/اقتراح/بلاغ مخاطر) وأولوية (منخفضة/متوسطة/عالية) ومرفقات اختيارية. ويمر البلاغ بسلسلة تصعيد مرتبطة بالهيكل الإداري: يبدأ عند مدير الفرع، فإن لم يُحل يتصاعد درجة درجة حتى يصل أعلى درجة HR في الشركة، مع سجل ردود كامل في كل مستوى.",
  ...
  },
  {
    ...
    bodyAr: [
      "نظام تواصل داخلي متكامل: لكل فرع غرفة دردشة عامة خاصة بها، وللمقر الرئيسي غرفته، ويستطيع المالك تفعيل غرفة موحدة لجميع الفروع أو إنشاء «مجموعات دردشة» تربط فروع مختارة معًا (مثل فرعي أ+ب في غرفة واحدة).",
  ...
  },
  {
    ...
    bodyAr: [
      "قسم تحليلي يقيس أداء الأفراد والفروع بالأرقام: نسب إنجاز المهام، وسرعة الاستجابة، وعدد المشكلات المبلغ عنها، والنقاط التحفيزية المكتسبة، مع شارات أداء ملونة توضح مستوى كل موظف في لمحة.",
      "يتيح القسم مقارنات مباشرة: موظف مقابل موظف، وفرع مقابل فرع، ومجموعة مقابل مجموعة — برسوم بيانية تفاعلية تكشف نقاط القوة والضعف، مع تقرير فردي مفصل لكل موظف يصلح للتقييم السنوي.",
  ...
  },
  {
    ...
    bodyAr: [
      "يرفع الموظفون تقارير يومية عن ورديّاتهم تمر بدورة اعتماد (بانتظار المراجعة → معتمد)، ويجمع قسم التقارير كل بيانات الشركة في جداول قابلة للتصفية حسب الفرع والفترة الزمنية والموظف.",
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "يمكن ربط الملف بفرع محددة ليظهر في سياقها، وحذف أي مجلد يحذف تلقائيًا كل محتوياته المتداخلة مهما بلغ عمقها، مع رسالة تأكيد قبل الحذف تحمي من الحذف الخاطئ.",
  ...
  },
  {
    ...
    bodyAr: [
      "«نيرو» مساعد ذكاء اصطناعي مدمج في المنصة يفهم سياق الشركة بالكامل: يجيب عن أسئلة مثل «كم مهمة متأخرة في فرع ألفا؟» أو «من الغائبون اليوم؟» اعتمادًا على بيانات الشركة الحقيقية، ويجيب بلغة المستخدم نفسها.",
  ...
  },
  {
    ...
    bodyAr: [
      "يعتمد NiroVera نموذج مخزون لامركزيًا يمنح كل فرع استقلالية تشغيلية كاملة: تسجل مشترياتها وأصنافها وكمياتها وأسعارها ومورديها وفواتيرها، وتتابع رصيد كل صنف في موقعه الحقيقي دون انتظار إدارة مركزية. وفي الوقت نفسه تحتفظ الإدارة العليا برؤية موحدة لكل الأرصدة والحركات والتكاليف عبر الشركة.",
      "تتم عمليات نقل المواد من خلال طلب رسمي بين فرعين يوضح الكمية المتاحة وقيمة التحويل، ثم يراجعه مسؤول الفرع الموردة. كما يسجل النظام الصرف لأعمال محددة، وصور المواد، وسجل الحركات قبل وبعد كل عملية، ويتيح للإدارة العليا عكس الحركة الخاطئة مع سبب موثق وأثر محسوب على الرصيد.",
      "تتوفر تقارير شاملة لكل فرع بصيغ PDF وExcel تشمل الأرصدة والمشتريات والاستهلاك والتحويلات، مع بحث مركزي باسم الصنف أو رمزه وإمكانية تصفية النتائج حسب فرع أو مجموعة فروع.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    titleEn: "Payroll",
    bodyAr: [
      "يربط قسم الرواتب بيانات الموظف الوظيفية بسجل الحضور والإجازات والغياب ليمنح الإدارة أساسًا موحدًا للمراجعة الشهرية. يمكن إعداد قوالب الرواتب واستيراد البيانات ومراجعة كل موظف وفرع، مع إبقاء البيانات المالية الحساسة ضمن نطاق الصلاحيات الممنوحة.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    bodyAr: [
      "يتيح قسم المصروفات للموظف رفع مطالبة مالية مرتبطة بفرع واحد أو بعدة فروع، مع تحديد نوع المصروف والتاريخ والكمية والمبلغ قبل الضريبة وقيمة الضريبة والإجمالي النهائي، وإرفاق صورة الإيصال أو الفاتورة كإثبات.",
      ...
      "توفر اللوحة مؤشرات وتقارير قابلة للتصفية حسب الفترة والفرع والنوع والحالة، مع تصدير منظم يساعد الإدارة على تحليل الإنفاق ومقارنة المصروفات بين المواقع.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    bodyAr: [
      "يحوّل قسم السلامة متطلبات HSE إلى ممارسة يومية قابلة للقياس: تصاريح عمل، وتقييم مخاطر، وقوائم فحص، وساعات عمل آمنة، وحوادث وإصابات وتوقفات مسجلة لكل فرع. ويمكن تخصيص حقول التصاريح والتبويبات بما يناسب طبيعة نشاط الشركة.",
  ...
  },
  {
    ...
    bodyAr: [
      "يجمع قسم الكاميرات بث المواقع في لوحة موحدة مرتبطة بفروع الشركة، مع عرض حالة كل كاميرا وموقعها على الخريطة وبيانات الاتصال الخاصة بها ضمن نطاق صلاحيات المستخدم.",
      "يدعم النظام إضافة الكاميرات واختبار الاتصال واستيراد بياناتها، وعرض البث المتوافق، مع تنظيم الأجهزة حسب الفرع لتسهيل وصول فرق التشغيل إلى المشهد المطلوب بسرعة.",
  ...
  },
  {
    ...
    bodyAr: [
      "ينظم NiroVera ورديات كل فرع حسب أيام الأسبوع وأنواع الدوام التي تحددها الشركة، مع إسناد الموظفين للورديات وتخصيص أوقات البداية والنهاية. ترتبط الجداول مباشرة بالحضور والتنبيهات، فتُفسَّر حالات التأخر والغياب وفق الوردية الصحيحة بدل الاعتماد على وقت موحد للجميع.",
