...
export const comparisonPages = [
  {
    number: "01", eyebrow: "EXECUTIVE COMPARISON • 2026", title: "NiroVera مقابل أنظمة SAP التقليدية",
    ...
    rows: [
      ...
      ["القرار الأنسب", "نظام تشغيل يومي مستقل مع موصلات اختيارية", "نظام السجل المالي والمؤسسي عند الحاجة", "استقلالية NiroVera"],
    ],
  ...
  {
    number: "02", eyebrow: "POWERCARE CAPABILITY MAP", title: "مميزات NiroVera من جميع الجوانب",
    intro: "القدرات التالية موجودة ضمن نطاق المنصة الحالي، ومصممة لتعمل في سياق واحد مترابط.",
    rows: [
      ["الهيكل والموارد البشرية", "شجرة مرنة، سحب وإعادة ترتيب، ملفات موظفين، درجات وصلاحيات", "Employee Central وهيكل مؤسسي واسع", "NiroVera أبسط بصريًا"],
      ["المحطات والميدان", "فرق ومواقع ونطاقات جغرافية ومؤشرات لكل محطة", "يتطلب نمذجة ووحدات وإعدادًا مناسبًا", "NiroVera أكثر تركيزًا"],
      ["الحضور والجداول", "حضور جغرافي، ورديات، استثناءات وتقارير", "حلول وقت وموارد بشرية مؤسسية", "حسب حجم وتعقيد الشركة"],
      ["المهام والتصعيد", "مهام وإثبات إنجاز وتصعيد مشتق من الشجرة", "سير عمل مؤسسي قابل للتكوين", "NiroVera مباشر"],
      ...
      ["السلامة والامتثال", "تصاريح ومخاطر وحوادث وLTI حسب المحطة", "حوكمة وامتثال قابلان للتوسع", "NiroVera أقرب للميدان"],
      ["الوثائق والتوقيع", "مجلدات، توقيع متعدد الأطراف، بصمة وتحقق", "إدارة مستندات وتكاملات مؤسسية", "NiroVera موحّد"],
      ["الأمن والكاميرات", "مركز كاميرات وتنبيهات وربط بالمحطات", "ليس محور ERP التقليدي", "ميزة تخصصية لـNiroVera"],
      ["التحليلات والذكاء", "مركز قرار وتنبيهات ومساعد Niro", "تحليلات وذكاء مؤسسي واسع", "عمق مختلف"],
      ["اللغة والجوال", "عربي وRTL وتجربة ميدانية تعمل باللمس", "دعم عالمي يتفاوت حسب التطبيق", "NiroVera ملائم محليًا"],
    ]
  },
  ...
  },
  {
    ...
    rows: [
      ["شركة متعددة المحطات", "اختيار قوي للتشغيل اليومي السريع", "مفيد إذا كانت لديها منظومة SAP قائمة", "NiroVera أولًا"],
      ["فرق ميدانية", "ملائم للحضور والمهام والسلامة والمخزون", "يحتاج تطبيقات أو تهيئة مكملة", "NiroVera أقرب"],
      ...
      ["سرعة واعتماد منخفض على الاستشاريين", "ميزة أساسية", "قد يعتمد على شركاء وخبراء", "NiroVera"],
      ["شركة تستخدم SAP بالفعل", "طبقة تشغيل ميدانية مكملة", "يبقى نظام السجل الأساسي", "تكامل ثنائي"],
      ["استقلالية المنتج", "يعمل دون SAP ويحافظ على قيمة NiroVera", "تكامل اختياري فقط", "الخيار الموصى به"],
    ],
    note: "التوصية: إبقاء NiroVera مستقلًا، وبيع تكامل SAP كإضافة مؤسسية يتحمل العميل تراخيص بيئتها وتكاليفها."
  },
  {
    number: "06", eyebrow: "METHODOLOGY & SOURCES", title: "المنهجية والمصادر",
    intro: "بُني جانب NiroVera على الوظائف الحالية في المنصة، وجانب SAP على الوصف الرسمي للمنتجات ووثائق التكامل المتاحة حتى يوليو 2026.",
    rows: [
