...
export const REPORT_CATALOG = [
  {
    ...
    descAr: "حالة كل محطة، المهام المنجزة، والانحرافات في صفحة واحدة.",
  ...
  },
  {
    ...
    kickerAr: "مالي",
    kickerEn: "FINANCE",
    titleAr: "تحليل تكلفة التشغيل بالمحطة",
    titleEn: "Cost per station analysis",
    descAr: "الرواتب والمخزون والصيانة منسوبة لكل محطة على حدة.",
  ...
  },
  {
    ...
    descAr: "أنماط التأخر، الغياب المتكرر، والمحطات المتجاوزة لحد الإضافي.",
...
export const SCHEDULED_REPORTS = [
  {
    ...
    titleAr: "التقرير اليومي الموحّد",
    titleEn: "Consolidated daily report",
    recipientsAr: "مدير العمليات · مدراء المحطات",
