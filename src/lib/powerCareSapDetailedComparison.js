export const detailedComparisonPages = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["الربط التشغيلي\nOperational context", "الكاميرا داخل سياق المحطة والتنبيه\nCamera sits inside site and alert context", "يُبنى عبر BTP/APIs وشركاء\nBuilt through BTP/APIs and partners", "NiroVera أوحد"],
    ],
    note: "حكم دقيق: SAP يمكنه التكامل مع الكاميرات، لكنه ليس نظام إدارة فيديو قياسيًا مثل مركز الكاميرات في NiroVera."
  },
  {
