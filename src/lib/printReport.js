...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .inventory-powercare .head { padding: 18px; border: 0; border-bottom: 2px solid #e0a43b; border-inline-start: 5px solid #e0a43b; background: #13283d; }
  .inventory-powercare .head h1 { color: #faf7f2; font-size: 26px; }
  ...
  .inventory-powercare .stat { border: 1px solid #ddd8cc; border-top: 4px solid #e0a43b; background: #faf7f2; box-shadow: 0 4px 12px rgba(19,40,61,.08); }
  .inventory-powercare .stat .val { color: #13283d; font-size: 25px; }
  .inventory-powercare .stat .lbl { color: #657383; font-size: 10px; }
  .inventory-powercare h2 { margin-top: 28px; padding: 9px 12px; border: 0; border-inline-start: 5px solid #e0a43b; background: #f1eadc; color: #13283d; }
  .inventory-powercare h2::before { display: none; }
  .inventory-powercare .chart { border-color: #ddd8cc; background: #faf7f2; box-shadow: 0 3px 10px rgba(19,40,61,.05); }
  ...
  .inventory-powercare table { border: 1px solid #d8d5cc; outline: 0; box-shadow: 0 3px 10px rgba(19,40,61,.05); }
  .inventory-powercare th { border-color: #29445f; background: #13283d; color: #f0c56d; font-size: 9px; letter-spacing: .04em; }
  .inventory-powercare td { border: 1px solid #e3e0d8; color: #13283d; }
  .inventory-powercare tr:nth-child(even) td { background: #faf8f2; }
  .inventory-powercare .foot { border-top: 2px solid #e0a43b; color: #657383; font-size: 9px; }
...
<body class="${isWide ? "wide" : "standard"} report-${visual.layout} ${theme === "executiveGold" ? "executive-gold" : ""} ${theme === "inventoryPowerCare" ? "inventory-powercare" : ""}">
