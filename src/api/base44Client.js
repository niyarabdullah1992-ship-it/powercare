...
const SESSION_SECURED_FUNCTIONS = new Set(['supabaseAttendance', 'supabaseTargets', 'operations', 'workforce', 'scores', 'workproof', 'dailyReport', 'hiring', 'org', 'payroll', 'signing', 'stock', 'budget', 'multiSign', 'calendarSync', 'cameraConnectionTest']);
