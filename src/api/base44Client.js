...
const SESSION_SECURED_FUNCTIONS = new Set(['supabaseAttendance', 'supabaseTargets', 'operations', 'workforce', 'scores', 'workproof', 'dailyReport', 'hiring', 'multiSign', 'calendarSync', 'cameraConnectionTest']);
