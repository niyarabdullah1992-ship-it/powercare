...
export default function PowerCareSapComparisonV2() {
  ...
  const download = async () => {
    ...
    await downloadProfilePdf(reportRef.current, setProgress, "PowerCare-SAP-Pain-Point-Comparison-AR-2026.pdf");
