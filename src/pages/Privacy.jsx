    ...
    <div className="powercare-public min-h-screen bg-landing-cinema px-4 py-10 font-body" dir="rtl">
      <div className="mx-auto max-w-3xl rounded-2xl border border-accent/20 bg-card px-6 py-10 text-card-foreground shadow-2xl shadow-accent/10 md:px-10">
        ...
        <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>تجمع منصة NiroVera البيانات اللازمة لتشغيل الخدمة فقط: بيانات حساب الشركة (الاسم والبريد الإلكتروني)، بيانات الموظفين المُدخلة من قِبل الشركة، وسجلات الحضور والمهام والتقارير. عند استخدام تسجيل الدخول عبر Google أو Microsoft أو Apple، نحصل فقط على معلومات الحساب الأساسية التي يتيحها مزود الخدمة، مثل البريد الإلكتروني والاسم، للتحقق من هويتك وإنشاء جلسة الدخول. لا نحصل على كلمة مرور حسابك لدى أي من هذه الخدمات.</p>
