...
export default function Inventory() {
  ...
  return <div className="space-y-6">
    ...
    {loading ? <div className="h-40 animate-pulse rounded-xl bg-muted" /> : <>
      ...
      {active === "procurement" && <ProcurementTab requests={state.procurementRequests} orders={state.purchaseOrders} stationId={activeStation} canApprove={state.canApproveProcurement} canReceive={state.canReceiveProcurement} run={run} ar={ar} />}
